...
tmux new-window -t <session> -n "task-N-short-name" \
  "claude -p '<filled-task-prompt>' \
    --plugin-dir ~/Projects/globalcoder-workflow \
...
Use globalcoder-workflow:finishing-a-development-branch to complete the work.
...
**Pairs with:**
- **globalcoder-workflow:brainstorming** — Creates design doc referenced by workers
