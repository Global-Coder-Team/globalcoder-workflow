...
**Pairs with:**
- **globalcoder-workflow:requesting-code-review** — Security review can complement code review
- **globalcoder-workflow:verification-before-completion** — Verify security fixes before claiming done
- **globalcoder-workflow:database-migration** — New tables need RLS policies reviewed
