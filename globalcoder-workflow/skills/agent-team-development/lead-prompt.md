...
4. **Count independent tasks:**
   - Fewer than 4? Suggest globalcoder-workflow:subagent-driven-development instead
...
4. **Present completion report to user:**
   ...
   - Test results
5. **Invoke globalcoder-workflow:finishing-a-development-branch** to guide merge/PR/cleanup
