...
**Pairs with:**
- **globalcoder-workflow:security-review** — New tables need RLS policy review
- **globalcoder-workflow:test-driven-development** — Write tests for new schema before migrating
- **globalcoder-workflow:verification-before-completion** — Verify migration + rollback both work
