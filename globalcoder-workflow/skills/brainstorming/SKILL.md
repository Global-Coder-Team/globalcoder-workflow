...
- Use globalcoder-workflow:using-git-worktrees to create isolated workspace
- Use globalcoder-workflow:writing-plans to create detailed implementation plan
