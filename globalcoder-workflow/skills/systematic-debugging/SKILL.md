...
1. **Create Failing Test Case**
   ...
   - Use the `globalcoder-workflow:test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **globalcoder-workflow:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **globalcoder-workflow:verification-before-completion** - Verify fix worked before claiming success
