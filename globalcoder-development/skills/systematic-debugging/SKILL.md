...
1. **Create Failing Test Case**
   ...
   - Use the `globalcoder-development:test-driven-development` skill for writing proper failing tests
...
| **4. Implementation** | Create test, fix, verify | Bug resolved, tests pass; OR if 3+ fixes failed → question architecture |
...
**Related skills:**
- **globalcoder-development:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **globalcoder-development:verification-before-completion** - Verify fix worked before claiming success
