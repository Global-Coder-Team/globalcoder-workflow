...
**Prerequisites:**
- Implementation plan from globalcoder-development:writing-plans
...
digraph process {
    ...
    "Completion report" -> "Use globalcoder-development:finishing-a-development-branch";
}
```
...
**Pairs with:**
- **globalcoder-development:brainstorming** - Creates design doc referenced by reviewers
- **globalcoder-development:using-git-worktrees** - Creates isolated workspace
- **globalcoder-development:requesting-code-review** - Optional final review before merge
