...
**Pairs with:**
- **globalcoder-development:systematic-debugging** — If performance issue has a root cause bug
- **globalcoder-development:verification-before-completion** — Verify improvement with numbers before claiming done
