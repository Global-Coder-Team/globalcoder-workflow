...
**Called by:**
- **globalcoder-development:subagent-driven-development** (Step 7) - After all tasks complete
- **globalcoder-development:executing-plans** (Step 5) - After all batches complete

**Pairs with:**
- **globalcoder-development:using-git-worktrees** - Cleans up worktree created by that skill
