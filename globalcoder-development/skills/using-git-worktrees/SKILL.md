...
2. ~/.config/globalcoder-development/worktrees/<project-name>/ (global location)
...
### For Global Directory (~/.config/globalcoder-development/worktrees)
...
case $LOCATION in
  .worktrees|worktrees)
    ...
    ;;
  ~/.config/globalcoder-development/worktrees/*)
    path="~/.config/globalcoder-development/worktrees/$project/$BRANCH_NAME"
    ;;
esac
...
**Called by:**
- **globalcoder-development:brainstorming** (Phase 4) - REQUIRED when design is approved and implementation follows
- Any skill needing isolated workspace

**Pairs with:**
- **globalcoder-development:finishing-a-development-branch** - REQUIRED for cleanup after work complete
- **globalcoder-development:executing-plans** or **globalcoder-development:subagent-driven-development** - Work happens in this worktree
