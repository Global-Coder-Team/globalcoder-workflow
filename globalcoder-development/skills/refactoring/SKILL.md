...
- Bug fixes that change behavior (use globalcoder-development:systematic-debugging)
- Adding new features (use globalcoder-development:test-driven-development)
...
**Pairs with:**
- **globalcoder-development:test-driven-development** — Write characterization tests in Phase 1
- **globalcoder-development:verification-before-completion** — Verify tests pass before claiming done
- **globalcoder-development:requesting-code-review** — Review after major refactoring complete
